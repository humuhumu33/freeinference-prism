...
decls = [
    ...
    structure("View", headline=STRING, lede=STRING, promptPlaceholder=STRING, sendLabel=STRING,
              ...
              providerBusyLabel=STRING, paidOfflineLabel=STRING, warmupLabel=STRING, siteKeyLabel=STRING, localModelName=STRING, loadingWord=STRING, peakRefusalLabel=STRING, seedModelName=STRING, seedModelLabel=STRING, largerLoadingLabel=STRING, promotedLabel=STRING, emptyAnswerLabel=STRING, paidModels=lst(named("PaidModel")),
    ...
    definition("view", [], named("View"), record("View",
        ...
        warmupLabel=s("Answered by OpenRouter while your model loads"), siteKeyLabel=s("Included, paid by this site"), localModelName=s("BitNet 2B"), loadingWord=s("loading"), peakRefusalLabel=s("The larger model needs a desktop with 24 GB of graphics memory"), seedModelName=s("SmolLM2 360M"), seedModelLabel=s("SmolLM2 360M, on your device"), largerLoadingLabel=s("getting BitNet 2B behind it"), promotedLabel=s("Now answering with BitNet 2B"), emptyAnswerLabel=s("The model gave no answer. Ask again"),
