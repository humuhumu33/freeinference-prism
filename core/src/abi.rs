...
pub fn view_json() -> Value {
    ...
    json!({
        ...
        "providerBusyLabel": v.providerBusyLabel, "paidOfflineLabel": v.paidOfflineLabel, "warmupLabel": v.warmupLabel, "siteKeyLabel": v.siteKeyLabel, "localModelName": v.localModelName, "loadingWord": v.loadingWord, "seedModelName": v.seedModelName, "seedModelLabel": v.seedModelLabel, "largerLoadingLabel": v.largerLoadingLabel, "promotedLabel": v.promotedLabel, "emptyAnswerLabel": v.emptyAnswerLabel, "peakRefusalLabel": v.peakRefusalLabel,
